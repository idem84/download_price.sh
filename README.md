...
Этого скрипта мало чтобы после его настройки и импорта сразу сайт заработал как надо. Необходимо хорошо разбираться в настройках админки битрикса чтобы новый импортированый каталог с товарами заработал. Там нужно настраивать инфоблоки, пути, указывать в настройках компонентов ID каталога или выбирать из списка нужный каталог по названию и т.д.
